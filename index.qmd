...
- **Video content, and estimated time to watch**: These sections include videos, which will take about 68 minutes to watch.
...
### [Target Parameters for an Associational or Causal Analysis](param.html)
...
### [Diagnostics for Checking Covariate Balance](balance.html)
...
### [Propensity Score Matching: Steps](psm.html)
...
### [Propensity Score Matching in Complex Surveys](psms.html)
...
### [Assumptions for Causal Analyses](assume.html) (Optional)
...
### [Propensity Score Weighting in Complex Surveys](psws.html) (Optional)
...
### [Reporting Guidelines for a Propensity Score Analysis](report.html) (Optional)
...
### [Additional Contents / Workshops](add.html) (Optional)
